  ...
  <div class="container text-center text-md-left">
    ...
    <div class="row text-center text-md-left mt-3 pb-3">
      ...
      <!-- <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
        ...
        <p>
          <a href="#!">Raspored Časova</a>
        </p>
        <p>
          <a href="#!">Postanite Partneri</a>
        </p>
        <p>
          <a href="#!">Pomoć</a>
        </p>
      ...
      <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
        ...
        <p>
          <i class="fas fa-home mr-3"></i> Resavska 28, Beograd</p>
        <p>
          <i class="fas fa-envelope mr-3"></i> umdples@gmail.com</p>
        <p>
          <i class="fas fa-phone mr-3"></i> 064 98 79 228</p>
      </div>
      <!-- Grid column -->
    </div>
    <!-- Footer links -->
...
<!-- lightbox JS -->
<script src="<?php echo URLROOT; ?>/js/lightbox-plus-jquery.min.js"></script>
</body>
</html>